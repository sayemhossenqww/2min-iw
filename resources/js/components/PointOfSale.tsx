...
class PointOfSale extends Component<Props, State> {
        ...
        httpService
            ...
            .then((response: any) => {
                if (response.data) {
                    ...
                    // this.printInvoice1(response.data.order.id);
                }
            })
            .finally(() => {
    ...
    printInvoice1 = (orderId: string) => {
        const invoiceUrl = `orders/print/${orderId}`; // Adjust the URL based on your Blade route
    ...
    handleInvoiceTypeChange = (event: React.ChangeEvent<HTMLSelectElement>): void => {
        this.setState({
            isGift: event.target.value == 'gift'
        });
    };
                ...
                <div className="d-flex py-3">
                    ...
                    <div className="d-flex">
                            <select
                                ...
                                defaultValue="normal"
                                onChange={e => this.handleInvoiceTypeChange(e)}>
                                <option value="normal">{t('Normal Invoice', 'الفاتورة العادية')}</option>
                                <option value="gift">{t('Gift Invoice', 'فاتورة الهدية')}</option>
                            </select>
                    </div>
                </div>
                <div className="row">
                            ...
                            <div className="modal-body py-0">
                                <div className="row">
                                    <div className="col-6 py-3 bg-primary-sec">
                                        <table className="table table-borderless" style={{ background: 'black' }}>
                                            <tbody>
                                                <tr>
