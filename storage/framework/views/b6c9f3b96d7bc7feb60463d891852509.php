...
<body>
    ...
    <div style="margin-bottom: 0.2rem;text-align: center !important;">
        ...
        <?php if($settings->storePhone): ?>
            <div style="font-size: 1rem; font-weight: bold;"><?php echo e($settings->storePhone); ?></div>
        <?php endif; ?>
    ...
    <div style="margin-bottom: 1.5rem">
        <?php $__currentLoopData = $order->order_details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div style="display: flex">
                <div><?php echo e($detail->quantity); ?> X <?php echo e($order->is_gift ? '*******' : $detail->view_price); ?></div>
                <div style="margin-left: auto"><?php echo e($order->is_gift ? '*******' : $detail->view_total); ?></div>
            </div>
    ...
    <?php if(!$order->is_gift): ?>
        ...
        <?php endif; ?>
        <?php if($order->is_delivery && $order->delivery_charge > 0): ?>
            <div style="display: flex;">
...
<?php /**PATH /Users/sayemh/Downloads/2miniw 2/bin/resources/views/orders/print/en.blade.php ENDPATH**/ ?>