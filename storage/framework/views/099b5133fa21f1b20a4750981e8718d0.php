<nav class="navbar navbar-expand-lg navbar-light bg-white border-bottom border-top">
    <div class="container-fluid">
        <a class="navbar-brand" href="<?php echo e(route('home')); ?>">
            ...
            <img src="<?php echo e(asset('images/logo.png')); ?>" height="70" alt="logo">
        </a>
...
<?php /**PATH C:\Users\Sayem Hossen\Downloads\phpdesktop-chrome-130.1-php-8.3\phpdesktop-chrome-130.1-php-8.3\www\resources\views/layouts/navbar.blade.php ENDPATH**/ ?>