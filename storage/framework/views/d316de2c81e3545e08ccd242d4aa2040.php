                ...
                <html>
                    ...
                    <body>
                        <div class="label">
                            <table>
                                <tr>
                                    <td colspan="3" align="center" style="width:100%;font-size:12px;">${description}</td>
                                </tr>
                                ...
                                <tr>
                                    <td style="font-size:12px;"  align="left">Size:<b>${size} </b></td>
                                    <td style="font-size:12px;" >Price:<b>$ ${cost}</b></td>
                                    <td style="font-size:12px;">Color:<b>${color}</b></td>
                                </tr>
                            </table>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /Users/sayemh/Downloads/Alla_Auto_Parts-2/resources/views/products/partials/form.blade.php ENDPATH**/ ?>