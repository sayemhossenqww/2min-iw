...
class Settings extends Model
{
    ...
    public static function getValues(): object
    {
        ...
        // Define default values to prevent errors
        $defaultValues = [
            Settings::LANGUAGE => 'en',
            Settings::SVG_LOGO => 'logo.svg',
            Settings::STORE_NAME => 'My Store',
            Settings::STORE_ADDRESS => '123 Street',
            Settings::STORE_PHONE_NUMBER => '123456789',
            Settings::STORE_WEBSITE => 'www.example.com',
            Settings::STORE_EMAIL => 'info@example.com',
            Settings::STORE_ADDITIONAL_INFO => '',
            Settings::DEFAULT_TAX_RATE => 10.0,
            Settings::VAT_TYPE => 'inclusive',
            Settings::DEFAULT_DELIVERY_CHARGE => 5.0,
            Settings::DEFAULT_DISCOUNT => 0.0,
            Settings::NEW_ITEM_AUDIO => true,
            Settings::TIMEZONE => 'UTC',
            Settings::DATE_FORMATE => 'Y-m-d',
            Settings::TIME_FORMATE => 'H:i:s',
            ...
            Settings::SHOW_TRAILING_ZEROS => true,
            Settings::SHOW_EXCHANGE_RATE_ON_RECEIPT => false,
            Settings::ENABLE_EXCHANGE_RATE_FOR_ITEMS => false,
            Settings::EXCHANGE_RATE => 1.0,
            Settings::EXCHANGE_CURRENCY => 'USD',
            Settings::ENABLE_TAKEOUT_AND_DELIVERY => true,
            Settings::ENABLE_CASH_DRAWER => true,
            Settings::STARTING_CASH => 100.0,
        ];
    
        // Use defaults if keys are missing
        foreach ($defaultValues as $key => $value) {
            if (!isset($settings[$key])) {
                $settings[$key] = (object)['value' => $value];
            }
        }
